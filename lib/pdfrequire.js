...
require(_basePath + "shared/util.js");
require(_basePath + "shared/colorspace.js");
require(_basePath + "shared/function.js");
require(_basePath + "shared/annotation.js");
require(_basePath + "core/core.js");
require(_basePath + "core/obj.js");
require(_basePath + "core/charsets.js");
require(_basePath + "core/crypto.js");
require(_basePath + "core/evaluator.js");
require(_basePath + "core/fonts.js");
require(_basePath + "core/font_renderer.js");
require(_basePath + "core/glyphlist.js");
require(_basePath + "core/image.js");
require(_basePath + "core/metrics.js");
require(_basePath + "core/parser.js");
require(_basePath + "core/stream.js");
require(_basePath + "core/worker.js");
require(_basePath + "core/jpx.js");
require(_basePath + "core/jbig2.js");
require(_basePath + "core/bidi.js");
require(_basePath + "core/jpg.js");
require(_basePath + "core/chunked_stream.js");
require(_basePath + "core/pdf_manager.js");
require(_basePath + "core/cmap.js");
require(_basePath + "core/cidmaps.js");
require(_basePath + "display/canvas.js");
require(_basePath + "display/font_loader.js");
require(_basePath + "display/metadata.js");
require(_basePath + "display/api.js");
  ...
  cls.prototype.parsePage = function (callback, errorCallBack) {
    ...
    function pageViewDrawCallback(error) {
      ...
      if (error) {
        ...
        nodeUtil.p2jinfo(
          "page " + (this.id + 1) + " is rendered successfully."
        );
        callback();
      }
    }
    ...
    PDFJS.getDocument(parameters).then(
      ...
      (error) =>
        this.raiseErrorEvent(
          "An error occurred while parsing the PDF: " + error
        )
    );
  };
