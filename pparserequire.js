...
let fs = require("fs"),
  ...
  _ = require("lodash"),
  async = require("async"),
  PDFJS = require("./lib/pdfrequire.js");
...
let PDFParser = (function () {
  ...
  // fq is a queue which can process 100 concurrently
  ...
  PdfParser.prototype.loadPDF = function (pdfFilePath, verbosity) {
    ...
    if (_processBinaryCache.call(this)) return;
    // callback function of _processPDFContent.bind(this) means this._processPDFContent()
  ...
  PdfParser.prototype.getRawTextContent = function () {
    return this.PDFJS.getRawTextContent();
  };
  PdfParser.prototype.getRawTextContentStream = function () {
    return _createContentStream(this.getRawTextContent());
  };

  PdfParser.prototype.getAllFieldsTypes = function () {
    return this.PDFJS.getAllFieldsTypes();
  };
  PdfParser.prototype.getAllFieldsTypesStream = function () {
    return _createContentStream(this.getAllFieldsTypes());
  };

  PdfParser.prototype.getMergedTextBlocksIfNeeded = function () {
    return { formImage: this.PDFJS.getMergedTextBlocksIfNeeded() };
  };
  PdfParser.prototype.getMergedTextBlocksStream = function () {
    return _createContentStream(this.getMergedTextBlocksIfNeeded());
  };
